    ...
    <div class="col-9 p-3 ">
        ...
        <form class="form-group" method="post" action="index.php?page=0">
            <div class="input-group mb-3">
                ...
                <input required name="mail" type="email" class="form-control" placeholder="Entrez votre adresse mail" aria-label="Mail" aria-describedby="basic-addon1">
            </div>

            <div class="form-group">
                <label for="exampleInputPassword1">Mot de passe</label>
                <input required name="motdepasse" type="password" class="form-control" id="exampleInputPassword1" placeholder="Entrez votre mot de passe">
            </div>
